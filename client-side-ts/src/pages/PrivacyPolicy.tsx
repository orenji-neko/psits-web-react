...
import { Shield, Lock, Eye, Share2, Bell, Mail, ChevronLeft } from "lucide-react";
                ...
                <div className="space-y-12">
                    <section className="space-y-4">
                        ...
                        <p className="body-text">
                            The Philippine Society of Information Technology Students (PSITS) Student Chapter
                            is committed to protecting your privacy. This Privacy Policy explains how we collect,
                            use, disclose, and safeguard your information when you visit our website or participate
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-4 body-text">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    <span className="font-semibold">Personal Data:</span> Name, email address, student number,
                                    course, and year level that you voluntarily give to us when you register for membership
                                    or events.
                                </li>
                                <li>
                                    <span className="font-semibold">Usage Data:</span> Information collected automatically
                                    when accessing the website, such as IP address, browser type, and operating system.
                                </li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-4 body-text">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>Communicate with you about upcoming events, news, and opportunities.</li>
                                <li>Improve our website and community services.</li>
                                <li>Comply with university and organizational transparency requirements.</li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="body-text">
                            ...
                            with university authorities or partner organizations only when necessary for official
                            school activities or legal compliance.
                        </p>
                    </section>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="text-info-text italic">
                                    Philippine Society of Information Technology Students<br />
